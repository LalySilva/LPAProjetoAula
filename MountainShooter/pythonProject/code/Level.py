...
from MountainShooter.pythonProject.code.Const import COLOR_WHITE, MENU_OPTION, EVENT_ENEMY
...
from MountainShooter.pythonProject.code.EntityMadiator import EntityMediator
from MountainShooter.pythonProject.code.Player import Player
